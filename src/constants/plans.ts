...
export const PLAN_DEFINITIONS: PlanDefinition[] = [
  {
    ...
    features: [
      ...
      'Astrólogo IA no WhatsApp — 20 conversas/mês',
    ],
  },
  {
    id: 'pro_monthly',
    ...
    features: [
      ...
      'Astrólogo IA no WhatsApp — 50 conversas/mês',
    ],
  },
  {
    id: 'premium_monthly',
    ...
    features: [
      ...
      'Previsões: 360 dias',
      'Astrólogo IA no WhatsApp — 85 conversas/mês',
    ],
  },
