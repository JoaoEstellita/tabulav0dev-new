...
export type DeckCard = PublicProfile & { score: number; tier: AffinityTier; harmonics: string[]; tensions: string[]; common: string[]; sameCity?: boolean; distanceKm?: number | null; chartOpen?: boolean; tzolkinKin?: number | null; tzolkinScore?: number | null; combinedScore?: number }
