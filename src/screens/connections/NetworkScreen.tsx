...
export default function NetworkScreen() {
  ...
  const buildMatchTour = useCallback(() => {
    ...
    return [
      ...
      { id: 'match.discover', onEnter: () => setPage('discover'), title: tl('Descobrir', 'Discover', 'Descubrir', 'Scopri'),
        body: tl('Um card por vez, por afinidade e proximidade. ✖️ passar, 🤝 pedir amizade, ❤️ dar Match. A barra "Assinatura cósmica" traz o Kin Tzolkin, o signo Védico e o signo Chinês; o score integra astrologia + Tzolkin + Védico (Guna Milan) + Chinês (BaZi). Toque em "ver aspectos" pra roda e grade.', 'One card at a time, by affinity and distance. ✖️ pass, 🤝 ask friendship, ❤️ Match. The "Cosmic signature" bar shows the Tzolkin Kin, the Vedic sign and the Chinese sign; the score blends astrology + Tzolkin + Vedic (Guna Milan) + Chinese (BaZi). Tap "see aspects" for the wheel and grid.', 'Una tarjeta a la vez, por afinidad y cercania. ✖️ pasar, 🤝 pedir amistad, ❤️ dar Match. La barra "Firma cosmica" trae el Kin Tzolkin, el signo Vedico y el signo Chino; el score integra astrologia + Tzolkin + Vedico (Guna Milan) + Chino (BaZi). Toca "ver aspectos".', 'Una card alla volta, per affinita e vicinanza. ✖️ passa, 🤝 amicizia, ❤️ Match. La barra "Firma cosmica" mostra il Kin Tzolkin, il segno Vedico e il segno Cinese; il punteggio unisce astrologia + Tzolkin + Vedico (Guna Milan) + Cinese (BaZi). Tocca "vedi aspetti".') },
  ...
  const { openTour: openMatchTour } = useTabTour('tour_seen_match_v2', 'Network', buildMatchTour)
