...
export const NATAL_PLANET_IN_HOUSE_PTBR_OVERRIDES: Record<string, string> = {
  ...
  'natal:sun|house|2':
    'O Sol na Casa 2 orienta a energia vital para a construção de segurança material e o desenvolvimento de valores pessoais sólidos. A autoestima tende a estar ligada ao que se produz, acumula ou sustenta com o próprio esforço. Trabalhar de forma consistente com recursos — finanças, talentos e tempo — e o caminho natural de autorrealização.',
  'natal:sun|house|3':
    'O Sol na Casa 3 direciona a expressão pessoal para a comunicação, o aprendizado e as trocas cotidianas com o ambiente próximo. Há uma curiosidade intelectual marcada, prazer em articular ideias e tendência a construir identidade através da palavra e do conhecimento. Irmãos, vizinhos e deslocamentos curtos tendem a desempenhar papel relevante na história pessoal.',
  'natal:sun|house|4':
    'O Sol na Casa 4 âncora a identidade na história familiar, no lar e na busca por raízes que oferecem segurança emocional. O sentido de quem se e tende a se desenvolver mais na vida privada do que em reconhecimentos externos, com o lar como espaço de centralização. A segunda metade da vida costuma trazer mais brilho e realização do que os primeiros anos.',
  'natal:sun|house|5':
  ...
  'natal:sun|house|6':
    'O Sol na Casa 6 orienta a energia vital para o serviço, o trabalho diário e a busca por um funcionamento cotidiano eficiente. A identidade tende a se expressar através da qualidade do que se entrega, do cuidado com a saúde e da competência técnica. O risco e centralizar autoestima no desempenho, perdendo de vista o valor próprio além das tarefas.',
  'natal:sun|house|7':
  ...
  'natal:sun|house|8':
    'O Sol na Casa 8 orienta a energia vital para a transformação profunda, a intimidade e os processos de renovação psicológica. Há uma tendência para lidar com o que e intenso, oculto ou compartilhado — recursos conjuntos, profundidade nas relações e os mistérios da existência. O crescimento pessoal costuma vir de confrontar o que e desconfortável e sair transformado.',
  'natal:sun|house|9':
  ...
  'natal:sun|house|10':
    'O Sol na Casa 10 coloca a carreira, a reputação e a direção pública como eixo central da expressão vital. Há uma orientação natural para autoridade, reconhecimento e a construção de um legado visível na vida profissional e social. A realização pessoal tende a se traduzir em conquistas que outros podem ver e validar.',
  'natal:sun|house|11':
  ...
  // ── Lua ────────────────────────────────────────────────────────────────────
  'natal:moon|house|1':
    'A Lua na Casa 1 torna as emoções, a sensibilidade e as reações instintivas parte visível da presença pessoal. Há uma tendência natural para captar o estado emocional do ambiente e responder com empatia, o que atrai as pessoas mas pode gerar instabilidade de humor sem autocuidado consistente. A expressão do self e fluida, muda com o contexto e reflete as necessidades emocionais do momento.',
  'natal:moon|house|2':
    'A Lua na Casa 2 conecta a segurança emocional diretamente a estabilidade material, tornando finanças e posses temas de grande carga afetiva. Conforto, nutrição e o ato de cuidar do próprio ambiente são fontes naturais de bem-estar interno. A relação com dinheiro tende a ser cíclica, alternando entre acúmulo e generosidade conforme o estado emocional.',
  'natal:moon|house|3':
    'A Lua na Casa 3 torna a comunicação um canal natural de expressão emocional, com tendência para falar, escrever e conectar-se através de palavras carregadas de sentimento. A mente e intuitiva e receptiva, captando nuances sutis do ambiente e das pessoas ao redor. Irmãos, vizinhança e deslocamentos curtos tendem a ter carga emocional significativa na história pessoal.',
  'natal:moon|house|4':
    'A Lua na Casa 4 âncora as necessidades emocionais no lar, na família e nas raízes, sendo uma das posições mais fortes para a Lua no mapa natal. Há uma vinculação afetiva intensa com a figura materna e com o sentido de pertencimento familiar, que se torna base para o equilíbrio interno. O lar e muito mais que espaço físico — e o centro emocional da vida.',
  'natal:moon|house|5':
  ...
  'natal:moon|house|10':
    'A Lua na Casa 10 coloca a vida emocional em contato direto com a esfera pública e profissional, tornando a carreira um campo de expressão das necessidades afetivas. Há uma sensibilidade natural para o que o público ou o coletivo precisa, o que pode favorecer carreiras de cuidado, comunicação ou liderança empática. A relação com a figura materna costuma influenciar a construção da trajetória profissional.',
  'natal:moon|house|11':
  ...
  'natal:mercury|house|11':
    'Mercúrio na Casa 11 conecta a mente ao coletivo, tornando a troca de ideias em grupos, redes e movimentos uma fonte natural de estímulo intelectual. Há prazer genuíno em debater, colaborar em projetos de grande alcance e comunicar ideias que beneficiem um público amplo. A inteligência coletiva funciona melhor do que o pensamento solitário — este Mercúrio prospera no contato com mentes diversas.',
  'natal:mercury|house|12':
    'Mercúrio na Casa 12 internaliza os processos mentais, criando uma vida intelectual mais intuitiva, reflexiva e menos orientada para a expressão pública. Há uma tendência para o pensamento simbólico, os sonhos e as conexões que emergem do inconsciente, tornando a introspecção um modo natural de processamento. A escrita privada, a meditação e o trabalho com a mente em espaços de silêncio tendem a ser mais produtivos do que ambientes de troca intensa.',

  // ── Vênus ───────────────────────────────────────────────────────────────────
  'natal:venus|house|1':
    'Vênus na Casa 1 coloca os valores estéticos e o charme no centro da expressão pessoal, tornando a aparência, os modos e a qualidade do primeiro contato temas centrais. Há uma tendência natural para atrair pessoas através do calor e da elegância na forma de se apresentar, com um senso refinado de gosto que e perceptível desde o início. O desafio e cultivar substância interior com a mesma atenção dedicada a imagem externa.',
  'natal:venus|house|2':
    'Vênus na Casa 2 conecta os valores estéticos ao mundo material, criando uma apreciação natural pela beleza nas posses e pelo conforto financeiro. Há prazer em construir um ambiente agradável e com gosto, e a autoestima tende a se vincular ao que se valoriza e cultiva. Recursos fluem com mais facilidade quando alinhados ao prazer genuíno e ao refinamento pessoal.',
  'natal:venus|house|3':
    'Vênus na Casa 3 traz charme e calor para a comunicação, tornando a conversa e a troca de ideias uma arena natural de prazer e conexão. Há um dom para expressar afeto através das palavras e uma apreciação genuína por inteligência, humor e expressão articulada. Vínculos com irmãos, vizinhos e o ambiente próximo tendem a ter dimensões harmônicas e estéticas significativas.',
  'natal:venus|house|4':
    'Vênus na Casa 4 traz apreciação pelo lar, pelas raízes e pela família como fontes de beleza e nutrição emocional. Há uma tendência para criar ambientes domésticos aconchegantes e esteticamente agradáveis, encontrando conforto genuíno na vida privada e nas conexões ancestrais. A segurança emocional e sustentada por ambientes que se sintam harmônicos e carregados de sentido pessoal.',
  'natal:venus|house|5':
  ...
  'natal:venus|house|6':
    'Vênus na Casa 6 traz apreciação pelo cuidado, pelo artesanato e pela qualidade do trabalho cotidiano. Há prazer em tarefas bem executadas, em práticas orientadas a saúde e no serviço realizado com atenção e elegância. O ambiente de trabalho tende a ser importante para o bem-estar, e os vínculos formados através de rotinas compartilhadas costumam ter calor genuíno.',
  'natal:venus|house|7':
    'Vênus na Casa 7 e uma posição clássica para a harmonia relacional, colocando o amor, as parcerias e a graça social no centro da expressão pessoal. Há um talento natural para a diplomacia, uma apreciação genuína pelos outros e uma tendência a prosperar através de conexões íntimas um a um. A parceria — romântica, profissional ou criativa — tende a ser uma fonte central de realização e beleza.',
  'natal:venus|house|8':
    'Vênus na Casa 8 conecta o amor e os valores estéticos a profundidade, a transformação e a intimidade. Há uma atração pelo intenso e pelo oculto, com relações tendendo a envolver profundidade psicológica genuína ou recursos compartilhados. A beleza e o prazer são experimentados como forças transformadoras, não como confortos superficiais.',
  'natal:venus|house|9':
    'Vênus na Casa 9 conecta o amor e a apreciação a horizontes amplos — filosofia, viagens, culturas diversas e a busca por sentido. Há prazer genuíno em aprender, em descobrir visões de mundo diferentes e em relações que expandem o senso do que e possível. A beleza e encontrada nas ideias, nas longas jornadas e nas tradições de sabedoria de diversas culturas.',
  'natal:venus|house|10':
    'Vênus na Casa 10 conecta a estética, a diplomacia e os dons relacionais a vida profissional e a reputação pública. Há uma habilidade natural para criar relações de trabalho harmônicas e para construir uma carreira em torno da beleza, das artes ou do serviço. O reconhecimento público tende a chegar por qualidades de graça, gosto ou capacidade de unir pessoas.',
  'natal:venus|house|11':
    'Vênus na Casa 11 orienta o amor e a apreciação para a comunidade, projetos coletivos e ideais de longo prazo. Há prazer genuíno na amizade, em empreendimentos colaborativos e em contribuir para causas que beneficiam muitos. Os círculos sociais tendem a ser calorosos e intelectual ou esteticamente estimulantes.',
  'natal:venus|house|12':
    'Vênus na Casa 12 internaliza o amor e a beleza, criando uma vida interior rica em compaixão, apreciação espiritual e serviço discreto. Há uma sensibilidade ao sofrimento e uma tendência a expressar afeto em privado, nos bastidores ou através de gestos de gentileza que passam despercebidos. As fontes mais profundas de prazer tendem a ser solitárias, místicas ou ligadas a trabalho criativo feito em recolhimento.',

  // ── Marte ───────────────────────────────────────────────────────────────────
  'natal:mars|house|1':
    'Marte na Casa 1 imprime energia, assertividade e um impulso direto para a ação na presença pessoal, tornando o indivíduo reconhecível por sua iniciativa e vitalidade. Há uma tendência para agir primeiro e refletir depois, com o corpo e a expressão física funcionando como canais primários de afirmação de identidade. O desafio e canalizar esse impulso de forma que inspire ao invés de intimidar.',
  'natal:mars|house|2':
  ...
  'natal:mars|house|3':
    'Marte na Casa 3 direciona a energia para a comunicação, a pesquisa e a busca incessante por conhecimento. Há um impulso marcado para investigar, questionar e chegar as conclusões lógicas das coisas — a mente funciona de forma rápida, direta e incansável. A escrita, o debate e a comunicação em todas as suas formas podem ser canais de expressão e realização.',
  'natal:mars|house|4':
    'Marte na Casa 4 impulsiona a energia para a construção de raízes, a busca por segurança e o estabelecimento de bases sólidas. Há uma motivação forte relacionada ao lar e a família — o ambiente doméstico pode ser um espaço de grande atividade, seja de construção literal ou de dinâmicas familiares intensas. O sentido de segurança interna e conquistado, não herdado passivamente.',
  'natal:mars|house|5':
  ...
  'natal:mars|house|10':
    'Marte na Casa 10 imprime um impulso marcado para gerenciar, organizar e construir uma trajetória profissional com determinação. Há uma orientação natural para a liderança prática, a tomada de decisões e a supervisão de processos — a carreira funciona como um campo de ação primário. O impulso para o reconhecimento profissional e consistente e pode se tornar uma força motriz central.',
  'natal:mars|house|11':
  ...
  'natal:jupiter|house|1':
    'Júpiter na Casa 1 expande a presença, a personalidade e o impacto sobre os outros, tornando o indivíduo naturalmente magnético, confiante e capaz de fascinar os que estão ao redor. Há uma orientação para a liderança espontânea e para a abertura de caminhos que outros podem seguir, com a vitalidade e o otimismo como recursos visíveis. O desafio e equilibrar a expansão pessoal com a escuta e o reconhecimento do que os outros trazem.',
  'natal:jupiter|house|2':
    'Júpiter na Casa 2 expande a relação com recursos materiais, talentos e valores pessoais, criando uma tendência para atrair oportunidades de prosperidade ao longo do tempo. Há uma resposta otimista ao que a vida oferece como possibilidade de crescimento, com o mundo dos negócios podendo se beneficiar dessa capacidade de reagir e construir. A generosidade com o que se possui tende a circular de volta de formas inesperadas.',
  'natal:jupiter|house|3':
    'Júpiter na Casa 3 expande a mente curiosa, a capacidade de pesquisa e as conexões com o ambiente imediato, criando um impulso natural de investigar, questionar e levar as coisas a conclusões significativas. Há prazer genuíno na comunicação, no aprendizado e na troca de ideias, com a carreira podendo se desenvolver em torno dessas qualidades. Vínculos com irmãos e vizinhos tendem a ter dimensões de crescimento ou oportunidade.',
  'natal:jupiter|house|4':
    'Júpiter na Casa 4 expande o sentido de raízes, lar e segurança, criando uma tendência para encontrar recursos e suporte na esfera privada e familiar. Há uma orientação para o crescimento através do que e interno — a história familiar, as raízes culturais e o lar como espaço de abundância. Uma vocação que possa se desenvolver a partir do que e pessoal e privado tende a ser natural.',
  ...
  'natal:jupiter|house|10':
    'Júpiter na Casa 10 expande a orientação prática, as habilidades de gestão e o impulso para construir uma carreira visível e significativa. Há uma tendência natural para a liderança, para colocar habilidades organizacionais a serviço de objetivos maiores e para se sentir em casa nas decisões que envolvem supervisão. O reconhecimento público tende a chegar através da competência prática e da capacidade de inspirar.',
  ...
  'natal:saturn|house|1':
    'Saturno na Casa 1 confere seriedade, reserva e disciplina a presença pessoal, tornando a abordagem ao mundo cuidadosa, deliberada e por vezes formalmente contida. Há uma tendência para não desperdiçar gestos ou palavras — o que e expresso carrega peso e intenção. A construção da identidade e um processo lento e consistente, com a maturidade tendendo a trazer mais confiança e reconhecimento do que a juventude.',
  'natal:saturn|house|2':
    'Saturno na Casa 2 imprime frugalidade e critério rigoroso na relação com recursos materiais e posses. Há uma tendência para limitar aquisições ao essencial e para valorizar o que tem durabilidade — tanto em objetos quanto em pessoas. A construção de segurança financeira tende a ser lenta, deliberada e baseada em esforço consistente, com colheitas possíveis no longo prazo.',
  'natal:saturn|house|3':
    'Saturno na Casa 3 torna a comunicação precisa, contida e orientada ao essencial, sem floreados ou superficialidades. Há uma determinação marcada quando se trata de trabalho mental e pesquisa, com uma capacidade de concentração que pode favorecer carreiras científicas ou acadêmicas. O aprendizado tende a ser sistemático e profundo, mesmo que mais lento do que o de mentes mais ageis.',
  'natal:saturn|house|4':
    'Saturno na Casa 4 pode tornar as raízes e o ambiente familiar uma fonte de responsabilidade ou limitação percebida, com o senso de segurança sendo algo a construir, não dado. Há uma tendência para necessidades simples no que diz respeito ao lar, com emoções e sentimentos por vezes experienciados de forma mais seca ou contida. A maturidade tende a trazer uma base mais sólida e a resolver o que parecia escasso na infância.',
  'natal:saturn|house|5':
    'Saturno na Casa 5 torna a auto-expressão mais comedida, com uma tendência para ser rígido consigo mesmo nas áreas de criatividade, romance e expressão de sentimentos. Há uma seriedade na abordagem ao prazer que pode gerar inibição ou dificuldade de soltar. Com o tempo, a expressão criativa tende a se tornar mais consistente e duradoura exatamente por não ser impulsiva ou efêmera.',
  'natal:saturn|house|6':
    'Saturno na Casa 6 torna as capacidades críticas e analíticas severas, com uma tendência para ser implacável na avaliação da qualidade — do próprio trabalho e dos outros. Há rigor no cuidado com a saúde, a alimentação e os processos de manutenção, podendo gerar tanto disciplina salutar quanto exigência excessiva. Trabalhar com outros pode ser mais desafiador do que trabalhar de forma independente.',
  'natal:saturn|house|7':
    'Saturno na Casa 7 torna as relações um campo de responsabilidade, compromisso e por vezes exigência elevada. Há uma tendência para levar parcerias a sério, com pouca tolerância a superficialidade e um desejo de construir vínculos duradouros. O desafio e equilibrar o senso de dever dentro das relações com abertura para a fluidez e o calor que a convivência também exige.',
  'natal:saturn|house|8':
    'Saturno na Casa 8 desenvolve uma exigência profunda em relação ao que e essencial, central e genuíno em qualquer situação. Há uma capacidade marcada para identificar o núcleo de uma questão e para exercer controle de qualidade em áreas que envolvem profundidade, recursos compartilhados ou responsabilidade. Negócios, gestão de heranças e psicologia profunda são áreas de possível competência.',
  'natal:saturn|house|9':
    'Saturno na Casa 9 torna a busca por verdade, filosofia e valores religiosos uma questão de seriedade e rigor intelectual. Há um cuidado meticuloso para separar o que e sólido e duradouro do que e efemero nas ideias e crenças. Para outros, essa postura pode parecer demasiado formal ou pessimista, mas tende a gerar uma visão de mundo consistente e fundamentada.',
  'natal:saturn|house|10':
    'Saturno na Casa 10 e uma das posições clássicas de orientação para a carreira com disciplina, persistência e compromisso com a própria reputação. Há uma orientação marcada para a praticidade, a organização e a construção deliberada de uma trajetória profissional sólida. A reputação e tratada com seriedade — e o trabalho ao longo do tempo, mais do que o talento espontâneo, que tende a definir o legado.',
  'natal:saturn|house|11':
    'Saturno na Casa 11 orienta o esforço para a realização de sonhos e ideais coletivos de forma persistente e disciplinada. Há uma seriedade no trabalho com grupos e comunidades, com pouca tendência a objetivos superficiais ou de curto prazo. Os ideais humanitários são centrais, mas o caminho para realiza-los costuma exigir tempo, consistência e tolerância a resultados lentos.',
  'natal:saturn|house|12':
    'Saturno na Casa 12 orienta a seriedade e a responsabilidade para o mundo interno, o sacrifício pessoal e o serviço silencioso aos outros. Há um compromisso profundo com o autoconhecimento, com a psicologia e com as dimensões místicas da existência. O cuidado com o outro e feito de forma meticulosa e deliberada, mesmo que raramente em evidência.',

  // ── Urano ───────────────────────────────────────────────────────────────────
  'natal:uranus|house|1':
    'Urano na Casa 1 confere excentricidade, originalidade e uma presença que frequentemente se destaca como diferente ou imprevisível. Há uma tendência para a espontaneidade, para a ruptura com convenções e para uma abordagem da vida que rompe com o esperado de forma criativa ou provocativa. A identidade e construída de forma não-linear, através de experimentação e autonomia radical.',
  'natal:uranus|house|2':
    'Urano na Casa 2 cria formas incomuns de se relacionar com recursos materiais e de sustentar a própria vida. Há uma tendência para um estilo econômico individualista, pouco convencional em relação aos padrões do grupo, com oscilações possíveis entre períodos de abundância e escassez. Novas formas de gerar sustento e de definir valor tendem a ser mais naturais do que seguir trilhas estabelecidas.',
  ...
  'natal:neptune|house|1':
    'Netuno na Casa 1 torna a presença pessoal fluida, magnética e por vezes difícil de definir ou categorizar. Há um charme místico e uma capacidade de encantar os outros com uma sensibilidade quasi-mediúnica, criando uma impressão que pode ser inspiradora mas também nebulosa. O desafio e desenvolver clareza de identidade em um self que naturalmente se dissolve nas percepções e projeções dos outros.',
  ...
  'natal:neptune|house|5':
    'Netuno na Casa 5 traz uma imaginação criativa expansiva, um forte senso dramático e uma habilidade para expressar ideias de sabor místico ou transcendente. Há prazer genuíno em encantar — crianças e adultos — com histórias, música, arte e experiências que tocam algo além do cotidiano. O romance tende a ser idealizado, com uma busca de algo que transcenda o ordinário.',
  'natal:neptune|house|6':
    'Netuno na Casa 6 traz criatividade e idealismo para as práticas de saúde, alimentação e rotina de cuidado. Há uma receptividade a abordagens holísticas e uma tendência para perceber os benefícios sutis do que alimenta corpo e mente. O cuidado com os outros pode ser uma vocação natural, desde que equilibrado para evitar auto-negligência ou sacrifício excessivo.',
  ...
  'natal:neptune|house|10':
    'Netuno na Casa 10 conecta as habilidades práticas a uma visão interior de natureza quasi-mística, permitindo manifestar ideais e sonhos de forma organizada na vida pública. Há uma aptidão para dar ao público um sentido do ideal — através de cinema, publicidade, trabalho espiritual ou qualquer área que una o concreto e o transcendente. A carreira pode ser difícil de definir claramente, mas tende a se revelar com o tempo.',
  ...
  // ── Plutão ──────────────────────────────────────────────────────────────────
  'natal:pluto|house|1':
    'Plutão na Casa 1 imprime intensidade, profundidade e um impulso para ir além das aparências na expressão pessoal e na abordagem da vida. Há uma presença que e percebida pelos outros antes mesmo de qualquer palavra ser dita — magnética, concentrada e por vezes intimidante. A identidade e construída através de processos de transformação profunda, com mortes simbólicas e renascimentos sendo parte da narrativa pessoal.',
  'natal:pluto|house|2':
    'Plutão na Casa 2 cria uma relação com o mundo material marcada por transformações, crises e aprofundamentos que ensinam o verdadeiro valor das coisas. Há uma habilidade para superar o superficial e identificar o que tem valor real em qualquer situação de negócios ou posses. A trajetória com recursos financeiros tende a incluir perdas e ganhos significativos que moldam uma sabedoria financeira profunda.',
  'natal:pluto|house|3':
    'Plutão na Casa 3 desenvolve uma mente investigativa que não se contenta com o superficial, sempre pesquisando, questionando e indo atrás de informações mais profundas. Há uma paixão pelo inquerito e pela comunicação de ideias com peso e substância. A escrita, a pesquisa e o debate tendem a ser canais de expressão de um pensamento que naturalmente vai fundo nas coisas.',
  'natal:pluto|house|4':
    'Plutão na Casa 4 torna o lar, a história familiar e o senso de segurança temas de transformação profunda e aprendizado real. Há uma sensibilidade acentuada nessa área, com mudanças que afetam o sentido de pertencimento sendo catalisadoras de crescimento interior. Trabalhar a relação com as raízes e com o passado familiar tende a ser um processo contínuo de ressignificação.',
  'natal:pluto|house|5':
    'Plutão na Casa 5 cria uma sensibilidade intensa na expressão criativa, no romance e na relação com crianças. Há períodos de criatividade intensa que permitem atravessar mudanças e crescimento interior profundo — a arte, a música e a escrita podem funcionar como canais de transformação. O romance tende a ser intenso, transformador e pouco superficial.',
  'natal:pluto|house|6':
    'Plutão na Casa 6 cria uma tendência para abordagens radicais de auto-análise, saúde e rotina de cuidado. Servir e cuidar de si mesmo e dos outros são fontes primarias de crescimento interior — e também de crises que revelam o que precisa ser transformado. Há uma sensibilidade a crítica que, quando trabalhada, se transforma em discernimento agucado.',
  'natal:pluto|house|7':
    'Plutão na Casa 7 torna as relações significativas arenas de transformação, intensidade e crescimento interior profundo. Casamento, parcerias e vínculos próximos tendem a ser intensos, não-superficiais e capazes de revelar camadas que estavam ocultas. A mudança e o crescimento interior chegam com mais frequência através do encontro transformador com o outro do que em solitário.',
  'natal:pluto|house|8':
    'Plutão na Casa 8 cria uma atração intensa pelo oculto, pela psicologia profunda, pela iniciação e pelo misticismo. Há um impulso para ir além das aparências em busca da essência — do que e real em qualquer situação, independentemente do desconforto que isso gere. Mudanças pessoais intensas e crescimento interior profundo são hábitos que se repetem ao longo de toda a vida.',
  'natal:pluto|house|9':
    'Plutão na Casa 9 cria uma paixão intensa pela busca da verdade e da essência, com uma abordagem analítica que vai fundo nos sistemas de crença, na filosofia e nos fundamentos do que se acredita. Há uma dificuldade de tolerar o efemero ou o superficial em qualquer discussão de ideias ou valores. Essa profundidade pode não ser facilmente compreendida pelos outros, mas gera insights de longo alcance.',
  'natal:pluto|house|10':
    'Plutão na Casa 10 traz um senso prático enorme — capaz de atravessar toda a burocracia e identificar as decisões corretas — aliado a uma capacidade de organizar e transformar o que e vulnerável na esfera pública e profissional. Há uma tendência para posições de poder transformador, onde o indivíduo lida com as camadas mais sensíveis das estruturas sociais ou organizacionais. O legado profissional tende a ser profundo e duradouro.',
  'natal:pluto|house|11':
    'Plutão na Casa 11 alimenta um ardente zelo pelo mundo ideal e uma necessidade de fazer parte de um grupo de almas afins orientadas para algo maior. Há uma aprendizagem real através dos esforços de colaboração e de tornar a visão interior em realidade coletiva. Grupos e movimentos sociais podem ser tanto fontes de poder quanto arenas de conflito que revelam dinâmicas ocultas.',
  'natal:pluto|house|12':
    'Plutão na Casa 12 cria uma aptidão natural para a psicologia profunda, para cavar abaixo da superfície da psique humana e compreender suas vulnerabilidades. Há uma paixão pelo auto-sacrifício e pela doação genuína em nome do que se acredita, com uma compreensão rara da complexidade humana. O trabalho de autoconhecimento e frequentemente a via de acesso a um poder pessoal que so se revela nas profundezas.',
}
