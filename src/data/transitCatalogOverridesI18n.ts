...
export const TRANSIT_CATALOG_I18N_OVERRIDES: Partial<Record<AppLanguage, TransitOverrideMap>> = {
  'en-US': {
    ...
    'transit:pluto|conjuncao|ascendente':
      'Pluto conjunct natal Ascendant marks a cycle of deep transformation of identity, the way one presents and the relationship with one\'s own body and self-image. The period may bring a more intense and magnetic presence, with the need to radically remodel who one is and how one is perceived. A moment of death and rebirth of identity, with potential for a more profound and radical authenticity.',
    'transit:pluto|conjuncao|jupiter':
      'Pluto conjunct natal Jupiter may amplify impulses of growth, power and expansion in an intense and potentially obsessive way. The period may bring opportunities of great impact, but also the risk of inflating one\'s own influence or seeking power compulsively. A moment of expansion that demands integrity, so that the generated force serves what is genuine and not the ego seeking to dominate.',
    'transit:pluto|conjuncao|mercury':
      'Pluto conjunct natal Mercury transforms the way of thinking, communicating and processing information, with a tendency toward deep dives into the investigation of truth. The period may bring mental intensity, thinking that goes to the core of issues and difficulty accepting superficial answers. A moment of deep intellectual renewal where the way of understanding reality undergoes significant transformation.',
    'transit:pluto|conjuncao|moon':
      'Pluto conjunct natal Moon initiates a cycle of deep transformation in the emotional world, inherited affective patterns and the relationship with what is felt as basic need. The period may bring confrontation with what has been repressed in the field of emotions and family bonds. A moment of affective renewal that may be intense, but that carries potential for a more authentic and integrated emotional life.',
    ...
    'transit:pluto|conjuncao|venus':
      'Pluto conjunct natal Venus transforms affective life, values and the relationship with pleasure and abundance in an intense and profound way. The period may bring bonds of great charge, revelations about what is truly desired, or confrontation with relationship patterns that must die for new ones to be born. A moment of deep affective renewal where what is genuine survives and what is superficial is eliminated.',
  ...
  'es-ES': {
    ...
    'transit:pluto|conjuncao|ascendente':
      'Pluton en conjuncion al Ascendente natal marca un ciclo de transformacion profunda en la identidad, en la forma de presentarse y en la relacion con el propio cuerpo e imagen personal. El periodo puede traer una presencia mas intensa y magnetica, con necesidad de remodelar radicalmente quien se es y como se es percibido por el entorno. Un momento de muerte y renacimiento de la identidad, con potencial para una autenticidad mas profunda y radical.',
    'transit:pluto|conjuncao|jupiter':
      'Pluton en conjuncion a Jupiter natal puede amplificar impulsos de crecimiento, poder y expansion de forma intensa y potencialmente obsesiva. El periodo puede traer oportunidades de gran impacto, pero tambien el riesgo de inflar la propia influencia o de buscar poder de manera compulsiva. Un momento de expansion que exige integridad, para que la fuerza generada sirva a lo que es genuino y no al ego que busca dominar.',
    'transit:pluto|conjuncao|mercury':
      'Pluton en conjuncion a Mercurio natal transforma la forma de pensar, comunicar y procesar informacion, con tendencia a inmersiones profundas en la investigacion de la verdad. El periodo puede traer intensidad mental, pensamiento que va al fondo de las cuestiones y dificultad en aceptar respuestas superficiales. Un momento de renovacion intelectual profunda, donde el modo de comprender la realidad pasa por una transformacion significativa.',
    'transit:pluto|conjuncao|moon':
      'Pluton en conjuncion a la Luna natal inicia un ciclo de transformacion profunda en el mundo emocional, en los patrones afectivos heredados y en la relacion con lo que se siente como necesidad basica. El periodo puede traer confrontacion con lo que fue reprimido en el campo de las emociones y los vinculos familiares. Un momento de renovacion afectiva que puede ser intenso, pero que contiene potencial para una vida emocional mas autentica e integrada.',
    'transit:pluto|conjuncao|neptune':
    ...
    'transit:pluto|conjuncao|venus':
      'Pluton en conjuncion a Venus natal transforma la vida afectiva, los valores y la relacion con el placer y la abundancia de forma intensa y profunda. El periodo puede traer vinculos de gran carga, revelaciones sobre lo que genuinamente se desea, o confrontacion con patrones de relacionamiento que deben morir para que nazcan nuevos. Un momento de renovacion afectiva profunda, donde lo genuino sobrevive y lo superficial es eliminado.',
    'transit:pluto|ingress|house_1':
  ...
  'it-IT': {
    ...
    'transit:pluto|conjuncao|ascendente':
      'Plutone in congiunzione con l Ascendente natale segna un ciclo di trasformazione profonda dell identita, del modo di presentarsi e del rapporto con il proprio corpo e l immagine personale. Il periodo puo portare una presenza piu intensa e magnetica, con la necessita di rimodellare radicalmente chi si e e come si e percepiti dall entorno. Un momento di morte e rinascita dell identita, con potenziale per un autenticita piu profonda e radicale.',
    'transit:pluto|conjuncao|jupiter':
      'Plutone in congiunzione con Giove natale puo amplificare gli impulsi di crescita, potere ed espansione in modo intenso e potenzialmente ossessivo. Il periodo puo portare opportunita di grande impatto, ma anche il rischio di gonfiare la propria influenza o di cercare il potere in modo compulsivo. Un momento di espansione che richiede integrita, affinche la forza generata serva cio che e genuino e non all ego che cerca di dominare.',
    'transit:pluto|conjuncao|mercury':
      'Plutone in congiunzione con Mercurio natale trasforma il modo di pensare, comunicare e processare informazioni, con tendenza a immersioni profonde nell investigazione della verita. Il periodo puo portare intensita mentale, pensiero che va al fondo delle questioni e difficolta nell accettare risposte superficiali. Un momento di profondo rinnovamento intellettuale, in cui il modo di comprendere la realta subisce una trasformazione significativa.',
    'transit:pluto|conjuncao|moon':
      'Plutone in congiunzione con la Luna natale avvia un ciclo di profonda trasformazione del mondo emotivo, dei pattern affettivi ereditati e del rapporto con cio che si sente come bisogno di base. Il periodo puo portare confronto con cio che e stato represso nel campo delle emozioni e dei legami familiari. Un momento di rinnovamento affettivo che puo essere intenso, ma che porta il potenziale per una vita emotiva piu autentica e integrata.',
    'transit:pluto|conjuncao|neptune':
    ...
    'transit:pluto|conjuncao|venus':
      'Plutone in congiunzione con Venere natale trasforma la vita affettiva, i valori e il rapporto con il piacere e l abbondanza in modo intenso e profondo. Il periodo puo portare legami di grande carica, rivelazioni su cio che si desidera genuinamente, o confronto con pattern relazionali che devono morire affinche ne nascano di nuovi. Un momento di profondo rinnovamento affettivo, in cui cio che e genuino sopravvive e cio che e superficiale viene eliminato.',
    'transit:pluto|ingress|house_1':
