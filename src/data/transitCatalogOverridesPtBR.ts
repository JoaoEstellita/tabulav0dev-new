export const TRANSIT_CATALOG_PTBR_OVERRIDES: Record<string, string> = {
  ...
  'transit:pluto|oposicao|venus':
    'Plutao em oposicao com Venus pode intensificar temas de valor, apego e reciprocidade nos vinculos. A fase pede revisar acordos afetivos e financeiros com mais clareza de limite. Escolhas consistentes tendem a fortalecer relacoes mais autenticas.',
  ...
  'transit:pluto|conjuncao|ascendente':
    'Plutao em conjuncao ao Ascendente natal marca um ciclo de transformacao profunda na identidade, na forma de se apresentar e na relacao com o proprio corpo e autoimagem. O periodo pode trazer uma presenca mais intensa e magnetica, com necessidade de remodelar radicalmente quem se e e como se e percebido pelo entorno. Um momento de morte e renascimento da identidade, com potencial para uma autenticidade mais profunda e radical.',
  'transit:pluto|conjuncao|jupiter':
    'Plutao em conjuncao a Jupiter natal pode amplificar impulsos de crescimento, poder e expansao de forma intensa e potencialmente obsessiva. O periodo pode trazer oportunidades de grande impacto, mas tambem o risco de inflar a propria influencia ou de buscar poder de maneira compulsiva. Um momento de expansao que exige integridade, para que a forca gerada sirva ao que e genuino e nao ao ego que busca dominar.',
  'transit:pluto|conjuncao|mercury':
    'Plutao em conjuncao a Mercurio natal transforma a forma de pensar, de comunicar e de processar informacoes, com tendencia a mergulhos fundos na investigacao da verdade. O periodo pode trazer intensidade mental, pensamento que vai ao fundo das questoes e dificuldade em aceitar respostas superficiais. Um momento de renovacao intelectual profunda, onde o modo de compreender a realidade passa por uma transformacao significativa.',
  'transit:pluto|conjuncao|moon':
    'Plutao em conjuncao a Lua natal inicia um ciclo de transformacao profunda no mundo emocional, nos padroes afetivos herdados e na relacao com o que e sentido como necessidade basica. O periodo pode trazer confronto com o que foi reprimido no campo das emocoes e dos vinculos familiares. Um momento de renovacao afetiva que pode ser intenso, mas que carrega potencial para uma vida emocional mais autentica e integrada.',
  ...
  'transit:pluto|conjuncao|venus':
    'Plutao em conjuncao a Venus natal transforma a vida afetiva, os valores e a relacao com o prazer e a abundancia de forma intensa e profunda. O periodo pode trazer vinculos de grande carga, revelacoes sobre o que de fato se deseja, ou confronto com padroes de relacionamento que precisam morrer para que novos possam nascer. Um momento de renovacao afetiva profunda, onde o que e genuino sobrevive e o que e superficial e eliminado.',
