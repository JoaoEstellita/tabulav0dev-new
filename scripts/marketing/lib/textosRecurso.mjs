...
export const RECURSO = {
  ...
  perfilAstrologico: {
    titulo: 'O que o mapa\ndiz de você',
    tela: 'perfil',
    texto: 'A roda mostra onde os planetas estão. O Perfil Astrológico diz o ' +
      'que isso significa: cada planeta no seu signo e na sua casa, os ' +
      'aspectos entre eles, o regente do mapa e os pontos angulares. São ' +
      'textos escritos e revisados um a um, não frases geradas na hora.',
    onde: 'Aba Perfil',
  ...
  statusDoDia: {
    titulo: 'O seu dia,\nem um número',
    tela: 'inicio',
    texto: 'O app compara o céu de hoje com o seu mapa e resume o resultado num ' +
      'score, com a faixa em que ele cai. Não é sorte do dia: é a soma dos ' +
      'trânsitos que tocam pontos do seu mapa agora, com peso por proximidade. ' +
      'Abaixo do número, o que puxou para cima e o que puxou para baixo.',
  ...
  oitoAreas: {
    titulo: 'Oito áreas,\noito respostas',
    tela: 'inicio',
    texto: 'Amor, saúde, família, comunicação, carreira, finanças, ' +
      'espiritualidade e transformação. Cada uma recebe a própria nota, porque ' +
      'o mesmo dia pode estar ótimo para conversar e péssimo para assinar ' +
      'contrato. A conta vem das casas e dos planetas que regem cada área.',
    onde: 'Aba Perfil',
  ...
  previsao: {
    titulo: 'O que vem\npela frente',
    tela: 'previsao',
    texto: 'Os eventos do céu nas próximas semanas, já filtrados pelo que toca ' +
      'o seu mapa: lunações, ingressos, eclipses e as viradas de retrógrado. ' +
      'Cada um com a data, a casa em que cai e o que costuma pedir. Serve para ' +
      'marcar o que importa antes de o mês começar.',
    onde: 'Aba Previsões',
  ...
  linhaDoTempo: {
    ...
    tela: 'previsao',
    texto: 'Um planeta, e todo o caminho dele: quando entra em cada signo, ' +
      'quando fica retrógrado, quando volta a andar, e em que casa sua isso ' +
      'acontece. Saturno leva dois anos e meio por signo, e ver esse período ' +
      'inteiro explica coisas que o dia de hoje sozinho não explica.',
  ...
  grupos: {
    titulo: 'O céu\ndos seus',
    tela: 'grupos',
    texto: 'Um grupo reúne as pessoas que você acompanha e mostra o dia de cada ' +
      'uma lado a lado. Dá para abrir o mapa completo de quem compartilhou o ' +
      'nascimento, e para criar perfil de quem não usa o app, como mãe, filho ' +
      'ou sócio, digitando os dados de nascimento.',
    onde: 'Aba Grupos',
  ...
  sinastria: {
    ...
    texto: 'Sinastria é o que acontece quando um mapa encosta no outro: onde os ' +
      'planetas de uma pessoa caem nas casas da outra, e que aspectos se ' +
      'formam entre os dois. Explica por que uma relação é fácil num assunto e ' +
      'trava sempre no mesmo outro.',
  ...
  agenteWhatsApp: {
    titulo: 'Astrologia\nno WhatsApp',
    tela: 'inicio',
    texto: 'Assinante conversa com o app pelo WhatsApp e recebe o resumo do dia ' +
      'de manhã. As respostas usam o mapa da pessoa, os trânsitos de hoje e os ' +
      'mesmos textos revisados do aplicativo, então a conversa não é chute nem ' +
